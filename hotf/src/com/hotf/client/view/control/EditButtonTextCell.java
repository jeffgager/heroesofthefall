 ...
 */
public class EditButtonTextCell extends
    AbstractEditableCell<String, EditButtonTextCell.ViewData> {
  ...
  private ImageResource editButton;

  /**
   * Construct a new EditTextCell that will use a
   * {@link SimpleSafeHtmlRenderer}.
   */
  public EditButtonTextCell(ImageResource editButton) {
   ...
   *          instance
   */
  public EditButtonTextCell(SafeHtmlRenderer<String> renderer) {
  ...
  private void createEditLink(SafeHtmlBuilder sb) {
	  sb.appendHtmlConstant("<div style='float: right;'><a title='Edit'>");
	  sb.append(imageRenderer.render(editButton));
